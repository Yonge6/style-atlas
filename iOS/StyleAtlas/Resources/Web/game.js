(() => {
  ...
  const text = {
    zh: {
      ...
      aboutPlus: "Plus 提供连续包月与连续包年两种自动续订方案，购买页会显示 App Store 返回的当前本地价格与续费条款。Plus 解锁其余完整风格档案、Guided Looking、Profile、Everyday、Comparison、创作表达、深入内容、无限收藏和高清多比例导出。",
    ...
    en: {
      ...
      aboutPlus: "Plus offers monthly and annual auto-renewing subscriptions. The purchase screen shows the current localized price and renewal terms returned by the App Store. Plus unlocks the remaining complete archives, Guided Looking, Profile, Everyday, Comparison, creative expression, deeper context, unlimited saved styles, and HD multi-ratio export.",
